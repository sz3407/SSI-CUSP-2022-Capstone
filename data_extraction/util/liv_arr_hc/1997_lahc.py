...
#MO, 21 drop erroneous characters
liv_arrs[21][3] = liv_arrs[21][3][:-6] #drop " j/ j/" (misc)

#NE, 23 drop erroneous characters
liv_arrs[23][3] = liv_arrs[23][3][:-1] #drop "-" (^4)

#NM, 27 drop erroneous characters
liv_arrs[27][0] = liv_arrs[27][0][:-1] #drop "a" (^3) 
